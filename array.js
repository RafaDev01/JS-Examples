...
frases_do_dia[5] = "Algo é impossível até que alguém duvide e prove o contrário"

var data_atual = new Date();

//Retorna o numero do dia atual do objeto Date()
var numero_escolhido = data_atual.getDate();

console.log("Número sorteado: " + numero_escolhido);

//Decrementando a variavel para que seja possível acessar o índice 0
numero_escolhido--;
...
console.log(frases_do_dia[5]);

//Exibindo o tamanho do Array
console.log(frases_do_dia.length);