//Declaração das variáveis que armazenam as chuvas de meteóros, \n adiciona quebra de linha
...
//O método getMonth() do objeto Date() retorna o mes atual que vai de 0 a 11 
let mes_atual = data_atual.getMonth();

//Abaixo estamos solicitando os dados do objeto Date() e atribuindo a uma variável
let semana_atual = data_atual.getDay();
let dia_atual = data_atual.getDate();
let hora_atual = data_atual.getHours();
let minutos_atual = data_atual.getMinutes();
let segundos_atual = data_atual.getSeconds();
let full_year = data_atual.getFullYear();

//Estrutura if capaz de identificar um trimestre a partir do número do mês 
